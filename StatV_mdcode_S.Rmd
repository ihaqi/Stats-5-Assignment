...
out.simple.model <- run.jags(model = "simple.txt", monitor = c("beta0mu", "beta1mu", "dic"), data = simple_model, inits = myinits, n.chains = nchains, adapt = nadapt, burnin = nburn, sample = niter)
