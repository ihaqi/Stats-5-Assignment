...
parameters.C.I.2 <- c("ss", "cor12","betamu", "betax", "sigma")

out.model.COR2 <- run.jags(model = "model_full_correlation_2", monitor = parameters.C.I.2, data = dataList.I.COR2, inits = myinits, n.chains = nchains, adapt = nadapt, burnin = nburn, sample = niter, thin = 200)

summary(out.model.COR2)
save(out.model.COR2,file = "out.model.COR2.thin.rdata")
