...
save(summary.1.main,file = "summary.1.main.rdata")
save(summary.2.main,file = "summary.2.main.rdata")
save(summary.1.sens,file = "summary.1.sens.rdata")
save(summary.2.sens,file = "summary.2.sens.rdata")
...
apa_table(x = sum.1, caption = "The first model", note = "Full model", landscape = TRUE, small = TRUE)
apa_table(x = sum.2, caption = "The Second model", note = "Reduced model", landscape = TRUE, small = TRUE)
apa_table(x = sum.sens.1, caption = "Sensitivity 1", note = "Sensitivity analysis 1.", landscape = TRUE, small = TRUE)
apa_table(x = sum.sens.2, caption = "Sensitivity 2", note = "Sensitivity analysis 2", landscape = TRUE, small = TRUE)
