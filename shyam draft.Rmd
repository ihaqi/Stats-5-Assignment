...
xyplot(LivingTogether ~ Age, type=c("smooth", "p")) #linear flat
...
as.data.frame(table(early.dat$livtog[early.dat$age==55]))
as.data.frame(table(early.dat$livtog[early.dat$age==56]))
as.data.frame(table(early.dat$livtog[early.dat$age==57]))
install.packages("DataExplorer")
library(DataExplorer)
create_report(early.dat)
```
