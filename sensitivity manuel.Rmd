...
out.model.COR2.sens <- run.jags(model = "model_full_correlation_2.sens", monitor = parameters.C.I.2.sens, data = dataList.I.COR2.sens, inits = myinits, n.chains = nchains, adapt = nadapt, burnin = nburn, sample = niter, thin = 200)

summary(out.model.COR2)
save(out.model.COR2,file = "out.model.COR2.sens.thick.rdata")
