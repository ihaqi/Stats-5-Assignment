...
out.model.COR <- run.jags(model = "model_full_correlation", monitor = parameters.C.I, data = dataList.I.COR, inits = myinits, n.chains = nchains, adapt = nadapt, burnin = nburn, sample = niter, thin = 1)

summary(out.model.COR)
save(out.model.COR,file = "out.model.COR.sen.thin.rdata")
```
...
save(dataList.I.COR2.sens, file = "datalist2.sens")
```
...
parameters.C.I.2.sens <- c("ss", "cor12","betamu", "betax", "sigma", "rand", "rand2")

out.model.COR2.sens <- run.jags(model = "model_full_correlation_2.sens", monitor = parameters.C.I.2.sens, data = dataList.I.COR2.sens, inits = myinits, n.chains = nchains, adapt = nadapt, burnin = nburn, sample = niter, thin = 1)
