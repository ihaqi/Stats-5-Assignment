...
list.of.packages <- c("knitr","rjags","runjags", "haven","psych","car","magicfor","lattice", "coda")
...
out.simple.model <- run.jags(model = "model_full_no_correlation", monitor = c("beta0mu", "betax"), data = dataList, inits = myinits, n.chains = nchains, adapt = nadapt, burnin = nburn, sample = niter)
